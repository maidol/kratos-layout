...
func wireApp(*conf.Server, *conf.Registry, *conf.Data, log.Logger, *tracesdk.TracerProvider, *prometheus.HistogramVec, *prometheus.CounterVec) (*kratos.App, func(), error) {
